 ...
 *  STATIC PROTOTYPES
 **********************/
static void window_create(monitor_t * m, const char * title);
static void window_update(monitor_t * m);
int quit_filter(void * userdata, SDL_Event * event);
static void monitor_sdl_clean_up(void);
static void monitor_sdl_init(const char * title);
 ...
 */
void monitor_init(const char * title)
{
    monitor_sdl_init(title);
...
#if 0
    printf("MONITOR_HOR_RES: %d\n", MONITOR_HOR_RES);
    printf("MONITOR_VER_RES: %d\n", MONITOR_VER_RES);
#endif
#if 0
...
static void monitor_sdl_init(const char * title)
{
    ...
    window_create(&monitor, title);
#if MONITOR_DUAL
    window_create(&monitor2, title);
    int x, y;
